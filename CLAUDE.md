...
| `kwaliteitscontrole-v4` | Kwaliteitscontrole | `…/prototypes/kwaliteitscontrole-v4/` (v4, mobiel-eerst, gebouwd n.a.v. de UX-review in `mockups/kwaliteitscontrole-ux/`; opgebouwd uit de delen in de scratchpad van die sessie, één zelfstandig bestand. Zelfde vier tabbladen als v3; de snippet stuurt tabblad, scherm, dag en objectnummer mee als custom data met `versie: v4`. **Zet de target op de prefix `…/prototypes/kwaliteitscontrole`**, dan landen v3 en v4 in hetzelfde project en zijn ze in Usersnap te scheiden op `versie`) |
| `kwaliteitscontrole` | Kwaliteitscontrole | `…/prototypes/kwaliteitscontrole/` (v3, referentie uit het bouwpakket; sinds v4 niet meer op de landingspagina maar nog live voor vergelijking. Eén pagina met vier tabbladen; de snippet stuurt tabblad, scherm en objectnummer mee als custom data. Eén bewuste afwijking van de aangeleverde referentie, op verzoek van Tim: de meervoudsvorm "vraagen" is op vijf plekken hersteld naar "vragen") |
